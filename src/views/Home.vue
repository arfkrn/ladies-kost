...
<template>
    ...
    <section class="hero" id="home">
        <div class="content">
            ...
            <div class="cta-container">
                <RouterLink to="/penawaran" class="cta"
                    >Sewa Sekarang</RouterLink
                >
            </div>
        </div>
    </section>
    ...
    <section id="tentang" class="tentang">
        ...
        <div class="tentang-container">
            ...
            <div class="tentang-p">
                <p>
                    Ladies Kost adalah tempat hunian nyaman dan aman yang
                    dirancang khusus untuk para wanita. Berlokasi strategis,
                    kost ini menyediakan fasilitas lengkap untuk mendukung
                    kebutuhan sehari-hari, mulai dari kamar tidur yang luas dan
                    bersih, koneksi WiFi cepat, hingga layanan laundry yang
                    praktis.
                </p>
                <p>
                    Kami mengutamakan privasi dan keamanan penghuni dengan
                    sistem keamanan 24 jam dan lingkungan yang tenang. Dengan
                    akses mudah ke berbagai fasilitas umum seperti pusat
                    perbelanjaan, kampus, dan transportasi, Ladies Kost adalah
                    pilihan ideal bagi Anda yang mencari hunian modern dengan
                    suasana yang nyaman dan bersahabat.
                </p>
                <p>
                    Bergabunglah dengan komunitas kami dan nikmati pengalaman
                    tinggal yang menyenangkan di Ladies Kost!
                </p>
            </div>
        </div>
    </section>
    ...
    <section id="lokasi" class="lokasi">
        ...
        <div class="lokasi-container">
            <p>
                “Lokasi kost kami bisa ditemukan di koordinat GPS:
                -5.116552,105.338211. Anda juga bisa menemukannya dengan
                menelusuri peta melalui Google Maps.”
            </p>
            <iframe
